...
class ShadowX:
    alias      = "SHADOW X"
    role       = ["Fullstack Developer", "Cheat Engineer", "Bot Architect", "Reverse Engineer"]
    languages  = ["C#", "C++", "Python", "JavaScript", "TypeScript", "Java"]
    speciality = ["Memory Manipulation", "Game Internals", "Desktop Bots", "Web Automation"]
    motto      = "𝗙𝗮𝗱𝗲 𝗶𝗻𝘁𝗼 𝘁𝗵𝗲 𝘀𝗵𝗮𝗱𝗼𝘄𝘀. 𝗘𝗺𝗲𝗿𝗴𝗲 𝗮𝘀 𝗰𝗼𝗱𝗲."

    def what_i_build(self):
        return [
            "🎮 Game Cheats & Internal Tools",
            "🌐 Fullstack Web Applications",
            "🤖 Desktop & Web Bots",
            "🛡️ Auth Systems & License Managers",
            "⚙️ Low-Level System Tools",
        ]
```
...
| 🎮 Cheat Engineering | 🌐 Fullstack Web | 🤖 Bots & Automation |
|:---:|:---:|:---:|
| Internal Cheats | React / Next.js Apps | Desktop Bots |
| Memory Reading/Writing | REST & GraphQL APIs | Web Scrapers |
| ESP / Aimbot Systems | Auth Systems | Image Recognition Bots |
| Game Reverse Engineering | Database Design | Task Automators |
| License / Auth Managers | Full UI/UX Design | AI-Powered Bots |
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/official-shadowx/official-shadowx/output/github-contribution-grid-snake-dark.svg" />
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/official-shadowx/official-shadowx/output/github-contribution-grid-snake.svg" />
  <img alt="Contribution Snake" src="https://raw.githubusercontent.com/official-shadowx/official-shadowx/output/github-contribution-grid-snake-dark.svg" />
</picture>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:16213e,50:1a1a2e,100:0d0d0d&height=120&section=footer&text=Stay+in+the+Shadows&fontSize=24&fontColor=00fff7&animation=twinkling" />
